    ...
    <body class="bg-gray-100">
        <div class="flex flex-col md:flex-row m-2 space-y-2 md:space-y-0">
            ...
            <div class="w-2/12 bg-red-900 text-white rounded-md p-4 md:p-2">
                <ul class="space-y-2">
                    <li class="cursor-pointer hover:bg-red-700 p-2 rounded" onclick="showContent('p21')">P21</li>
                    <li class="cursor-pointer hover:bg-red-700 p-2 rounded" onclick="showContent('rj')">Restorative Justice</li>
                    <li class="cursor-pointer hover:bg-red-700 p-2 rounded" onclick="showContent('sp2lid')">SP2LID</li>
                    <li class="cursor-pointer hover:bg-red-700 p-2 rounded" onclick="showContent('tahap-2')">Tahap 2</li>
                    <li class="cursor-pointer hover:bg-red-700 p-2 rounded" onclick="showContent('sp3')">SP3</li>
                </ul>
            </div>

            <!-- Content Area (Peta) -->
            <div class="w-11/12 bg-gray-100 rounded-md p-4 relative ml-0 md:ml-2" id="content-area">
                <div id="p21" class="content hidden">Peta P21 Provinsi Aceh</div>
                <div id="rj" class="content hidden">Peta Restorative Justice Provinsi Aceh</div>
                <div id="sp2lid" class="content hidden">Peta SP2LID Provinsi Aceh</div>
                <div id="tahap-2" class="content hidden">Peta Tahap 2 Provinsi Aceh</div>
                <div id="sp3" class="content hidden">Peta SP3 Provinsi Aceh</div>
        ...
        <script>
            ...
            function getColor(rank) {
                ...
                } else if (rank == 2) { // Tingkat ketiga
                    return '#5CE65C'; // Warna untuk tingkat ketiga
                } else if (rank == 1) { // Tingkat ketiga
                    return '#008000'; // Warna untuk tingkat ketiga
                } 
            }
